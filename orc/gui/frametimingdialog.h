 ...
 *
 * Displays composite frame sample data as a waveform graph with:
 * - Y-axis: sample value in mV
 * - X-axis: sample position across the full frame (lines 1 to 525/625)
 *
 * Lines are numbered sequentially 1 to N (525 for NTSC, 625 for PAL).
 */
class FrameTimingDialog : public QDialog {
 ...
 private:
  ...
  FrameTimingWidget* timing_widget_;
