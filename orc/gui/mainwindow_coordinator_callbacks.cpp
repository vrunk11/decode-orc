...
{
    // On failure the worker never emits previewReady, so preview_render_in_flight_
    // would stay true permanently.  Clear it here so the normal render path recovers.
