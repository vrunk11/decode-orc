...
ORC_STAGE_PLUGIN_EXPORT bool orc_register_stage_plugin(
  ...
  if (node_type_info.display_name !=
          orc::plugins::dropout_map::kStageDisplayName ||
      node_type_info.menu_category !=
          orc::plugins::dropout_map::kStageMenuCategory ||
      ...
      node_type_info.min_outputs !=
          orc::plugins::dropout_map::kStageMinOutputs ||
      node_type_info.max_outputs !=
          orc::plugins::dropout_map::kStageMaxOutputs ||
      node_type_info.compatible_formats !=
          orc::plugins::dropout_map::kStageCompatibleFormats ||
      node_type_info.sink_category !=
          orc::plugins::dropout_map::kStageSinkCategory) {
    if (error_message) {
      *error_message =
  ...
  if (!register_stage(context, orc::plugins::dropout_map::kStageName,
                      &create_stage)) {
    if (error_message) {
