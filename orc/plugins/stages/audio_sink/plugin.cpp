...
ORC_STAGE_PLUGIN_EXPORT bool orc_register_stage_plugin(
  ...
  if (node_type_info.display_name !=
          orc::plugins::audio_sink::kStageDisplayName ||
      node_type_info.menu_category !=
          orc::plugins::audio_sink::kStageMenuCategory ||
      ...
      node_type_info.min_outputs !=
          orc::plugins::audio_sink::kStageMinOutputs ||
      node_type_info.max_outputs !=
          orc::plugins::audio_sink::kStageMaxOutputs ||
      node_type_info.compatible_formats !=
          orc::plugins::audio_sink::kStageCompatibleFormats ||
      node_type_info.sink_category !=
          orc::plugins::audio_sink::kStageSinkCategory) {
    if (error_message) {
      *error_message =
  ...
  if (!register_stage(context, orc::plugins::audio_sink::kStageName,
                      &create_stage)) {
    if (error_message) {
