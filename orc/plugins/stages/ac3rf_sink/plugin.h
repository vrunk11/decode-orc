 ...
 * Purpose:     Plugin entrypoint metadata for AC3RFSinkStage
 *
...
namespace orc::plugins::ac3rf_sink {

inline constexpr const char* kStageName = "AC3RFSink";

inline constexpr const char* kStageDisplayName = "AC3 RF Sink";
