...
class ByteWithErasureFlag {
 public:
  ...
  explicit ByteWithErasureFlag(GFValue<8, irreducible_poly, alpha> v)
      : m_value(v.getInt()), m_erased(false) {}

  template <int irreducible_poly, int alpha>
  explicit ByteWithErasureFlag(GFValue<8, irreducible_poly, alpha> v, bool e)
      : m_value(v.getInt()), m_erased(e) {}

  template <int irreducible_poly, int alpha>
  GFValue<8, irreducible_poly, alpha> gfValue() const {
