...
namespace orc
{
    void AC3RFSinkStageDeps::init(TriggerProgressCallback progress_callback, std::atomic<bool>* cancel_requested)
    {
        ...
        const std::string& output_path)
    {
        ...
        return {true, frames_written, "Success: " + std::to_string(frames_written) + " frames written"};
    }
} // namespace orc
