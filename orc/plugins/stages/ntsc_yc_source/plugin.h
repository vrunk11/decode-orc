 ...
 * Purpose:     Plugin entrypoint metadata for NTSCYCSourceStage
 *
...
namespace orc::plugins::ntsc_yc_source {

inline constexpr const char* kStageName = "NTSC_YC_Source";

inline constexpr const char* kStageDisplayName = "NTSC YC Source";
...
inline constexpr orc::StagePluginDescriptor kPluginDescriptor{
    "decode-orc.stage.ntsc_yc_source",
