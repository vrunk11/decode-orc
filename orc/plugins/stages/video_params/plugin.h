 ...
 * Purpose:     Plugin entrypoint metadata for VideoParamsStage
 *
...
namespace orc::plugins::video_params {

inline constexpr const char* kStageName = "video_params";

inline constexpr const char* kStageDisplayName = "Video Parameters";
