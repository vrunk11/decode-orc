    ...
    const char** error_message)
{
    ...
    if (node_type_info.display_name != orc::plugins::video_params::kStageDisplayName ||
        node_type_info.menu_category != orc::plugins::video_params::kStageMenuCategory ||
        node_type_info.type != orc::plugins::video_params::kStageNodeType ||
        node_type_info.min_inputs != orc::plugins::video_params::kStageMinInputs ||
        node_type_info.max_inputs != orc::plugins::video_params::kStageMaxInputs ||
        node_type_info.min_outputs != orc::plugins::video_params::kStageMinOutputs ||
        node_type_info.max_outputs != orc::plugins::video_params::kStageMaxOutputs ||
        node_type_info.compatible_formats != orc::plugins::video_params::kStageCompatibleFormats ||
        node_type_info.sink_category != orc::plugins::video_params::kStageSinkCategory) {
        if (error_message) {
    ...
    if (!register_stage(context, orc::plugins::video_params::kStageName, &create_stage)) {
        if (error_message) {
