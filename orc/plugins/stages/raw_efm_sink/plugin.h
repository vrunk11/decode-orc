 ...
 * Purpose:     Plugin entrypoint metadata for RawEFMSinkStage
 *
...
namespace orc::plugins::raw_efm_sink {

inline constexpr const char* kStageName = "RawEFMSink";

inline constexpr const char* kStageDisplayName = "Raw EFM Data Sink";
