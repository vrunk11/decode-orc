 ...
 * Purpose:     Plugin entrypoint metadata for FieldMapStage
 *
...
inline constexpr const char* kStageName = "field_map";

inline constexpr const char* kStageDisplayName = "Field Map";
