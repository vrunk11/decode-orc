 ...
 * Purpose:     Plugin entrypoint metadata for DaphneVBISinkStage
 *
...
namespace orc::plugins::daphne_vbi_sink {

inline constexpr const char* kStageName = "daphne_vbi_sink";

inline constexpr const char* kStageDisplayName = "Daphne VBI Sink";
...
inline constexpr orc::StagePluginDescriptor kPluginDescriptor{
    "decode-orc.stage.daphne_vbi_sink",
