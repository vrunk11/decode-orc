 ...
 * Purpose:     Plugin entrypoint metadata for SNRAnalysisSinkStage
 *
...
namespace orc::plugins::snr_analysis_sink {

inline constexpr const char* kStageName = "snr_analysis_sink";

inline constexpr const char* kStageDisplayName = "SNR Analysis Sink";
...
inline constexpr orc::StagePluginDescriptor kPluginDescriptor{
    "decode-orc.stage.snr_analysis_sink",
