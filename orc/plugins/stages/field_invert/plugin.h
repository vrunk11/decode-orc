 ...
 * Purpose:     Plugin entrypoint metadata for FieldInvertStage
 *
...
namespace orc::plugins::field_invert {

inline constexpr const char* kStageName = "field_invert";

inline constexpr const char* kStageDisplayName = "Field Invert";
