 ...
 * Purpose:     Plugin entrypoint metadata for RawVideoSinkStage
 *
...
namespace orc::plugins::raw_video_sink {

inline constexpr const char* kStageName = "raw_video_sink";

inline constexpr const char* kStageDisplayName = "Raw Video Sink";
...
inline constexpr orc::StagePluginDescriptor kPluginDescriptor{
    "decode-orc.stage.raw_video_sink",
