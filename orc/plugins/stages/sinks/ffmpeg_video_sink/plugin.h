 ...
 * Purpose:     Plugin entrypoint metadata for FFmpegVideoSinkStage
 *
...
namespace orc::plugins::ffmpeg_video_sink {

inline constexpr const char* kStageName = "ffmpeg_video_sink";

inline constexpr const char* kStageDisplayName = "FFmpeg Video Sink";
...
inline constexpr orc::StagePluginDescriptor kPluginDescriptor{
    "decode-orc.stage.ffmpeg_video_sink",
