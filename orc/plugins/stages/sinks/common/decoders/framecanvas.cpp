...
int32_t FrameCanvas::bottom() { return videoParameters.last_active_frame_line; }

int32_t FrameCanvas::left() { return videoParameters.active_video_start; }

int32_t FrameCanvas::right() { return videoParameters.active_video_end; }
...
FrameCanvas::Colour FrameCanvas::rgb(uint16_t r, uint16_t g, uint16_t b) {
  ...
  return Colour{((sr * 0.299) + (sg * 0.587) + (sb * 0.114)) + blackIre,
...
void FrameCanvas::drawRectangle(int32_t xStart, int32_t yStart, int32_t w,
                                int32_t h, const Colour& colour) {
...
void FrameCanvas::fillRectangle(int32_t xStart, int32_t yStart, int32_t w,
                                int32_t h, const Colour& colour) {
  for (int32_t y = yStart; y < yStart + h; y++) {
