...
class FIRFilter {
 public:
  constexpr FIRFilter(const Coeffs& coeffs_) : coeffs(coeffs_) {}
  ...
  void apply(const InputSample* inputData, OutputSample* outputData,
  ...
  void apply(const InputContainer& inputData,
             OutputContainer& outputData) const {
