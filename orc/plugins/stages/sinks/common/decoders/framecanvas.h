...
class FrameCanvas {
 public:
  // componentFrame is the frame to draw upon, and videoParameters gives its
  // parameters. (Both parameters are captured by reference, not copied.)
  ...
  void fillRectangle(int32_t x, int32_t y, int32_t w, int32_t h,
                     const Colour& colour);
