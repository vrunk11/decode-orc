 ...
 * Purpose:     Plugin entrypoint metadata for PALYCSourceStage
 *
...
namespace orc::plugins::pal_yc_source {

inline constexpr const char* kStageName = "PAL_YC_Source";

inline constexpr const char* kStageDisplayName = "PAL YC Source";
...
inline constexpr orc::StagePluginDescriptor kPluginDescriptor{
    "decode-orc.stage.pal_yc_source",
