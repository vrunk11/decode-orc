 ...
 * Purpose:     Plugin entrypoint metadata for CCSinkStage
 *
...
namespace orc::plugins::cc_sink {

inline constexpr const char* kStageName = "CCSink";

inline constexpr const char* kStageDisplayName = "Closed Caption Sink";
