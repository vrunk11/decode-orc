 ...
 * Purpose:     Plugin entrypoint metadata for MaskLineStage
 *
...
namespace orc::plugins::mask_line {

inline constexpr const char* kStageName = "mask_line";

inline constexpr const char* kStageDisplayName = "Mask Line";
