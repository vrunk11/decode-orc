...
ORC_STAGE_PLUGIN_EXPORT bool orc_register_stage_plugin(
  ...
  if (node_type_info.display_name !=
          orc::plugins::mask_line::kStageDisplayName ||
      node_type_info.menu_category !=
          orc::plugins::mask_line::kStageMenuCategory ||
      ...
      node_type_info.compatible_formats !=
          orc::plugins::mask_line::kStageCompatibleFormats ||
      node_type_info.sink_category !=
          orc::plugins::mask_line::kStageSinkCategory) {
    if (error_message) {
      *error_message =
  ...
  if (!register_stage(context, orc::plugins::mask_line::kStageName,
                      &create_stage)) {
    if (error_message) {
