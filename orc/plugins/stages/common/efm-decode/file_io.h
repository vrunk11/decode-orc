...
inline bool writeBinaryData(const std::string& filename,
...
inline std::vector<uint8_t> readBinaryData(const std::string& filename,
                                           size_t maxSize = 0) {
