...
static_assert(kPALStage.stage_name[0] != '\0', "PAL stage name must not be empty");
static_assert(kNTSCStage.stage_name[0] != '\0', "NTSC stage name must not be empty");
static_assert(kPALStage.stage_display_name[0] != '\0', "PAL display name must not be empty");
static_assert(kNTSCStage.stage_display_name[0] != '\0', "NTSC display name must not be empty");
static_assert(kPALStage.stage_menu_category[0] != '\0', "PAL menu category must not be empty");
static_assert(kNTSCStage.stage_menu_category[0] != '\0', "NTSC menu category must not be empty");

static_assert(kPALStage.stage_max_inputs >= kPALStage.stage_min_inputs, "PAL inputs invalid");
static_assert(kPALStage.stage_max_outputs >= kPALStage.stage_min_outputs, "PAL outputs invalid");
static_assert(kNTSCStage.stage_max_inputs >= kNTSCStage.stage_min_inputs, "NTSC inputs invalid");
static_assert(kNTSCStage.stage_max_outputs >= kNTSCStage.stage_min_outputs, "NTSC outputs invalid");
