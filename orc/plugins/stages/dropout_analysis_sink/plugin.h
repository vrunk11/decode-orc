 ...
 * Purpose:     Plugin entrypoint metadata for DropoutAnalysisSinkStage
 *
...
namespace orc::plugins::dropout_analysis_sink {

inline constexpr const char* kStageName = "dropout_analysis_sink";

inline constexpr const char* kStageDisplayName = "Dropout Analysis Sink";
...
inline constexpr orc::StagePluginDescriptor kPluginDescriptor{
    "decode-orc.stage.dropout_analysis_sink",
