 ...
 * Purpose:     Plugin entrypoint metadata for NTSCCompSourceStage
 *
...
namespace orc::plugins::ntsc_comp_source {

inline constexpr const char* kStageName = "NTSC_Comp_Source";

inline constexpr const char* kStageDisplayName = "NTSC Composite Source";
...
inline constexpr orc::StagePluginDescriptor kPluginDescriptor{
    "decode-orc.stage.ntsc_comp_source",
