 ...
 * Purpose:     Plugin entrypoint metadata for BurstLevelAnalysisSinkStage
 *
...
namespace orc::plugins::burst_level_analysis_sink {

inline constexpr const char* kStageName = "burst_level_analysis_sink";

inline constexpr const char* kStageDisplayName = "Burst Level Analysis Sink";
inline constexpr const char* kStageMenuCategory = "Sink (Analysis)";

inline constexpr orc::NodeType kStageNodeType = NodeType::ANALYSIS_SINK;
...
inline constexpr orc::SinkCategory kStageSinkCategory = SinkCategory::ANALYSIS;
...
inline constexpr orc::StagePluginDescriptor kPluginDescriptor{
    "decode-orc.stage.burst_level_analysis_sink",
