...
bool NtscTBCYCConverter::check_yc_phase_alignment(int luma_colour_frame_index,
...
std::string NtscTBCYCConverter::yc_alignment_error(int luma_colour_frame_index,
                                                    int chroma_colour_frame_index) {
  if (check_yc_phase_alignment(luma_colour_frame_index, chroma_colour_frame_index)) {
    return {};
  }
