        ...
        try {
            ...
            if (stage_services_) {
                ...
                public:
                    ...
                    void write(const uint16_t* data, size_t count) override { if (impl_) impl_->write(data, count); }
                    void write(const std::vector<uint16_t>& data) override { if (impl_) impl_->write(data); }
                ...
                auto writer16 = stage_services_->create_buffered_file_writer_uint16(16 * 1024 * 1024);
                if (writer16) {
