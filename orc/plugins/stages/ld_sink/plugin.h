 ...
 * Purpose:     Plugin entrypoint metadata for LDSinkStage
 *
...
namespace orc::plugins::ld_sink {

inline constexpr const char* kStageName = "ld_sink";

inline constexpr const char* kStageDisplayName = "ld-decode Sink";
