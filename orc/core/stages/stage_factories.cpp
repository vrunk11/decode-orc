...
std::shared_ptr<IDaphneVBISinkStageDeps>
StageFactories::CreateInstanceDaphneVBISinkStageDeps(
...
std::shared_ptr<IDaphneVBIWriterUtil>
StageFactories::CreateInstanceDaphneVBIWriterUtil(
