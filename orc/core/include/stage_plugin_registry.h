...
#error "GUI code cannot include core/include/stage_plugin_registry.h. Use ProjectPresenter for plugin-aware stage access."
#endif
#if defined(ORC_CLI_BUILD)
#error "CLI code cannot include core/include/stage_plugin_registry.h. Use ProjectPresenter for plugin-aware stage access."
#endif
...
public:
    ...
    static std::string serialize_yaml(const std::vector<StagePluginRegistryEntry>& entries);
