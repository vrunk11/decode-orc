...
enum class CVBSEncodingPreset {
    ...
    CVBS_U16_4FSC = 1,
    // Device-encoded composite: requires offset/scale reversal (typically 0-255 mapped to wide range)
    CVBS_TPG21_4FSC = 2
};
...
{
    switch (preset) {
        case CVBSEncodingPreset::CVBS_U16_4FSC: return "CVBS_U16_4FSC";
        case CVBSEncodingPreset::CVBS_TPG21_4FSC: return "CVBS_TPG21_4FSC";
...
struct CVBSSourceMetadata {
    ...
    bool is_valid_for_cvbs_source() const
    {
        ...
        if (video_standard != VideoSystem::PAL && video_standard != VideoSystem::NTSC) {
            return false;
        }
...
struct CVBSSourceParameters {
    ...
    std::string sample_encoding = "CVBS_U16_4FSC";    // Manual mode: encoding preset
